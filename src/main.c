...
static void print_version()
{
	...
	printf(_("Copyright (C) %s jeanfi@gmail.com\n"
			 "Copyright (C) %s pztrn@pztrn.name\n"
...
static void print_help()
{
	...
	puts(_("ptasker is a task management user interface based"
		   " on taskwarrior."));
...
int main(int argc, char **argv)
{
	...
	err = NULL;
	ret = gtk_builder_add_from_file(builder,
	...
	if (!ret)
	{
		...
		diag = GTK_MESSAGE_DIALOG(gtk_message_dialog_new(NULL,
														 GTK_DIALOG_DESTROY_WITH_PARENT,
														 GTK_MESSAGE_ERROR,
														 GTK_BUTTONS_CLOSE,
														 msg,
